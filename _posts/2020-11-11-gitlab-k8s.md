...
Continuing my GitLab and Kubernetes (k8s) odyssey from ({% post_url 2019-08-28-kubernetes-on-debian %}) I've learned two things:
...
Therefore I setup a `pre_clone_script` to rewrite the `/etc/resolv.conf`:
